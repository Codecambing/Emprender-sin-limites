...
// **Filtrar solo cuentas activas (`dado_de_baja = 'no')**
$sql = "SELECT id_usuario, nombre, fotoperfil FROM usuarios WHERE dado_de_baja = 'no'";
...
if ($result->num_rows > 0) {
    ...
    echo "No hay cuentas activas disponibles.";
}
...
<head>
    ...
    <link rel="stylesheet" href="css/cuentas_activas.css">
</head>
<body>
        ...
        <div class="user-list">
            <?php if (!empty($usuarios)): ?>
                <?php foreach ($usuarios as $user): ?>
                    <div class="user-item">
                        <a href="perfil_usuario.php?id=<?= $user['id_usuario']; ?>" class="user-link">
