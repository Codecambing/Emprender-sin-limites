...
// **Filtrar proyectos inactivos (dado_de_baja = 'SI')**
$sql = "SELECT 
        p.id_proyectos, 
        p.nombre_proyecto, 
        p.descripcion, 
...
if ($result->num_rows > 0) {
    ...
    echo "No hay proyectos inactivos disponibles.";
}
...
<head>
    ...
    <title>Proyectos Inactivos</title>
    <link rel="stylesheet" href="css/proyectos_inactivos.css">
</head>
<body>
    <div class="project-page">
        <div class="container">
            <div class="project-list">
                <h2 class="proyecto">Proyectos Dados de Baja</h2>
                <ul id="projectList">
                    <?php if (!empty($proyectos)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>No hay proyectos dados de baja.</p>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
